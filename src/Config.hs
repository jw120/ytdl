...
combine clopts configFromJSON = Config {
  ...
  maxVideos     = fromMaybe Def.maxVideos    ((maxVideos :: ConfigFromJSON -> Maybe Int) configFromJSON),
  defaultFormat = fromMaybe Def.videoFormat  ((defaultFormat :: ConfigFromJSON -> Maybe String) configFromJSON),
